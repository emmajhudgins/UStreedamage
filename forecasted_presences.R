...
data2<-read.csv('datanorm.csv', stringsAsFactors = FALSE) # species data, see 
rr<-which(data2$YEAR<10)
data2<-data2[rr,]
#Hudgins et al. corrigendum for information on why ALB (spp=3) cannot be accurately fit
...
prez2<-read.csv('prez2_rr.csv')[,2:10] # pest presences in 2000 for the 3 species examined here, in 2009 for all other species
...
saveRDS(presences_time, file="presences_time_rr2.rds")
